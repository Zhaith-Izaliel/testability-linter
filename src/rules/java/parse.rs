...
mod tests {
    ...
    #[case::one_void("tests/inputs/java/check_no_void/invalid/VoidMethod.class", true)]
    #[case::two_void("tests/inputs/java/check_no_void/invalid/TwoVoidMethod.class", true)]
    #[case::three_void("tests/inputs/java/check_no_void/invalid/ThreeVoidMethod.class", true)]
    #[case::four_void("tests/inputs/java/check_no_void/invalid/FourVoidMethod.class", true)]
    #[case::five_void("tests/inputs/java/check_no_void/invalid/FiveVoidMethod.class", true)]
    #[case::zero_void("tests/inputs/java/check_no_void/valid/NoVoidMethod.class", true)]
    #[case::main_method("tests/inputs/java/check_no_void/valid/MainMethod.class", true)]
    #[case::constructor("tests/inputs/java/check_no_void/valid/ConstructorMethod.class", true)]
